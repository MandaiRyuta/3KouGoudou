...
//	const std::string NUMBER = "resource/texture/NumberSet.png";
	const std::string BUTTONB = "resource/texture/A.png";
	const std::string BUTTONA = "resource/texture/B.png";
	const std::string BUTTONX = "resource/texture/X.png";
	const std::string BUTTONY = "resource/texture/Y.png";

	const std::string RUPI = "resource/texture/rupi.png";
