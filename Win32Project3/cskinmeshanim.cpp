...
CSkinMesh::CSkinMesh() {
	...
	//速度
	m_CurrentTrackDesc.Speed = 0.01f;
}
...
D3DXMATRIX CSkinMesh::GetBoneOffsetMtx(LPSTR _BoneName)
{
	MYFRAME* pFrame = SearchBoneFrame(_BoneName, m_pFrameRoot);
...
D3DXMATRIX CSkinMesh::GetBoneTranslateMtx(LPSTR _BoneName)
{
	MYFRAME* pFrame = SearchBoneFrame(_BoneName, m_pFrameRoot);
